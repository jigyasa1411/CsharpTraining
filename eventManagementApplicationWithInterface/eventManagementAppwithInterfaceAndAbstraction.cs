...
namespace EventManagementApplicationWithInterface
{
    abstract class Event //PARENT CLASS
    {
...
namespace EventManagementApplicationWithInterface
{
    ...
    class Birthday : Event, IprintEndMessage //Implementing multiple inheritance using interfaces.
    {
        ...
        {   
            ...
            {
                Console.WriteLine("\n"); 
                Console.WriteLine("Congratulations!!!! Registration for {0} event is successful.", setEventName());
            }
        ...
        // Defining body of the interface's success method
        public void endMessage()
        {
            Console.WriteLine("\n");
...
namespace EventManagementApplicationWithInterface
{
    ...
    class Wedding : Event, IprintEndMessage  //Implementing multiple inheritance using interfaces.
    {
        // Method to set event name.
        public string setEventName()
        {
...
namespace EventManagementApplicationWithInterface
{
    ...
    class Reception : Event, IprintEndMessage  //Implementing multiple inheritance using interfaces.
    {
        // Method to set event name.
        public string setEventName()
        {
...
namespace EventManagementApplicationWithInterface
{
    ...
    class Engagement : Event, IprintEndMessage  //Implementing multiple inheritance using interfaces.
    {
        // Method to set event name.
        public string setEventName()
        {
